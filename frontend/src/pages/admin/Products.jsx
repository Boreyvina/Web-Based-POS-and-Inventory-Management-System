...
export default function Products() {
  ...
  const [showingBatches, setShowingBatches] = useState(null);
  ...
  return (
    <>
                    ...
                    <tr key={p.id} className="hover:bg-slate-50/60">
                      ...
                      <td className="px-4 py-3">
                        <div className="flex justify-end gap-1">
                          ...
                          <RowAction onClick={() => setShowingBatches(p)}>Batches</RowAction>
      ...
      <BatchesModal
        open={Boolean(showingBatches)}
        onClose={() => setShowingBatches(null)}
        product={showingBatches}
      />
