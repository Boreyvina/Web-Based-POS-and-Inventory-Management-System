...
export const productApi = {
  ...
  batches: (id) => api.get(`/products/${id}/batches`).then((r) => r.data),
};
...
export const purchaseApi = {
  ...
  get: (id) => api.get(`/purchase-orders/${id}`).then((r) => r.data.data),
  create: (payload) => api.post('/purchase-orders', payload).then((r) => r.data.data),
  send: (id) => api.patch(`/purchase-orders/${id}/send`).then((r) => r.data),
  receive: (id, payload) => api.post(`/purchase-orders/${id}/receive`, payload).then((r) => r.data.data),
  cancel: (id, reason) => api.patch(`/purchase-orders/${id}/cancel`, { reason }).then((r) => r.data),
  suggestions: () => api.get('/purchase-orders/suggestions').then((r) => r.data),
};
...
export const reportApi = {
  ...
  byCashier: (params) => api.get('/reports/by-cashier', { params }).then((r) => r.data.data),
  /**
